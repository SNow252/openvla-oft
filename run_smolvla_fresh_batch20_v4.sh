...
export FRESH_ROOT=/home/asd/projects/vla_lang_generalization/goal_controllability_verifier/data/fresh_policy_dumps_v4/smolvla_multicond_20seeds_$(date +%Y%m%d_%H%M%S)
...
run_one_condition() {
  ...
  lerobot-eval \
    ...
    --policy.device=cuda \
    --policy.use_amp=true \
    --job_name="smolvla_${cond}_fresh_20seeds" \
